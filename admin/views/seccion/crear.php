...
<form action="seccion.php?accion=<?php if ($accion == "crear"):
    echo ('nuevo');
else:
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="text" name="data[seccion]" placeholder="Escribe aquí el nombre" class="form-control" value="<?php if (isset($secciones['seccion'])):
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="number" name="data[area]" placeholder="Escribe aquí el área" class="form-control" value="<?php if (isset($secciones['area'])):
                echo ($secciones['area']);
            endif; ?>" />
        </div>
    </div>
