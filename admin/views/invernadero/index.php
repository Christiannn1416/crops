          ...
          <tr>
            ...
            <td>
              <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                <a href="invernadero.php?accion=actualizar&id=<?php echo $invernadero['id_invernadero']; ?>"
                  class="btn btn-primary" style="margin-right:1rem;">Actualizar</a>
                <a href="invernadero.php?accion=eliminar&id=<?php echo $invernadero['id_invernadero']; ?>"
