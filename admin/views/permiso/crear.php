...
<form action="permiso.php?accion=<?php echo ($accion == "crear") ? 'nuevo' : 'modificar&id=' . $id; ?>" method="post">
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="text" name="data[permiso]" placeholder="Escribe aquí el nombre del permiso"
                class="form-control" value="<?php echo isset($permiso['permiso']) ? $permiso['permiso'] : ''; ?>"
                required />
        </div>
    </div>
